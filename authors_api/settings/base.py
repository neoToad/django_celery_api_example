...
LOCAL_APPS = [
    'core_apps.common', 'core_apps.users', 'core_apps.profiles',
    'core_apps.articles', 'core_apps.favorites', 'core_apps.reactions',
    'core_apps.comments', 'core_apps.search', 'core_apps.ratings'
]
...
ADMINS = [("""Colin Hennigar""", "colinjmass@gmail.com")]
...
DJOSER = {
    ...
    "SERIALIZERS": {
        ...
        "user_delete": "core_apps.users.serializers.UserDeleteSerializer",
    },
}
